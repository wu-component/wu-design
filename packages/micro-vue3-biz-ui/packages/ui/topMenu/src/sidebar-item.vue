...
let resolvePath = (routePath: string) => {
  ...
  const baseUrl = proxy.basePath.endsWith('/')? proxy.basePath: `${proxy.basePath}/`;
  const routeUrl = routePath.startsWith('/')? routePath.slice(1): routePath;
